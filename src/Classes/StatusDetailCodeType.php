...
class StatusDetailCodeType {
    ...
    const IDEMPOTENCY_ERROR = "IDEMPOTENCY_ERROR";
    ...
    const MISSING_MANDATORY_FIELDS = "MISSING_MANDATORY_FIELDS";
    const MISSING_REQD_FLD = "MISSING_REQD_FLD";
    const MISSNG_ACCT_PRD = "MISSNG_ACCT_PRD";
    const MISSNG_REC_SERVICE = "MISSNG_REC_SERVICE";
    ...
    const NONEXISTENT_FIELD = "NONEXISTENT_FIELD";
    ...
    const OPERATION_NOT_FINISHED = "OPERATION_NOT_FINISHED";
    ...
    const SERVER_SIDE_VALIDATION_FAILED = "SERVER_SIDE_VALIDATION_FAILED";
    ...
    const TOS_IS_NOT_ACCEPTED = "TOS_IS_NOT_ACCEPTED";
